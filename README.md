...
- **悬浮预览**：2D 和 3D 视图中，鼠标悬停到任意格子会显示毛玻璃气泡，包含颜色预览和色卡编号

![image-20260408185417123](README.assets/image-20260408185417123.png)

- **导出图纸**：支持导出 `PNG` 和 `PDF`，图纸上每一格都标有对应的官方色卡编号

![img](README.assets/ad397ca3a9f5d9f25a504238a4ed70ea.png)
